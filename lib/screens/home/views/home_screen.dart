import 'package:apps/screens/add_expense/blocs/create_category_bloc/create_category_bloc.dart';
...
import 'package:apps/screens/add_expense/views/add_expense.dart';
        ...
        builder: (context, state) {
          if(state is GetExpensesSuccess) {
            return Scaffold(
                ...
                body: index == 0
                    ? MainScreen(user: widget.user, state.expenses)
                    : const StatsScreen());
          } else {
